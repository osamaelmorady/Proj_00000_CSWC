...
elseif(${ARCHITECTURE} STREQUAL "AVR")
   ...
   set(CMAKE_LINKER                    ${COMPILER_PATH}/bin/avr-gcc)
...
elseif(${COMPILER_TYPE} STREQUAL "GCC-AVR")
    set(PROJECT_DEFAULT_C_FLAGS -g -Wall -Wextra -shared -mmcu=${MICROCONTROLLER} -DF_CPU=${MCU_CPU_CLOCK})
    set(PROJECT_DEFAULT_ASM_FLAGS  -g -Wall -Wextra -shared -mmcu=${MICROCONTROLLER} -DF_CPU=${MCU_CPU_CLOCK})
